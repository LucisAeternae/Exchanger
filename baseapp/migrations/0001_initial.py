# Generated by Django 2.1.4 on 2018-12-23 10:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='baseapp.Game')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.AddField(
            model_name='offer',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='baseapp.Profile'),
        ),
        migrations.AddField(
            model_name='category',
            name='game',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='baseapp.Game'),
        ),
    ]
